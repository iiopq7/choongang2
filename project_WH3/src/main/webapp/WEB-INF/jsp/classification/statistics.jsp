...
<body>
	...
	<button id="position_search" style="width:200px; height:30px; margin-top:30px; background-color: hsl(197, 100%, 51%); color:white; outline: none; border: none;" onClick="statistics_search()">검색</button>
</body>
</html>